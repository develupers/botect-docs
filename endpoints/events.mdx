...
<ParamField body="events" param-type="array" required="true">
  ...
  <Expandable title="event">
    ...
    <ParamField body="type" param-type="string" required="true">
      ...
      `snapshot` (collector v1.3.0+) carries the complete behavioural picture and is sent on every flush, with every field present — including zeros. The four per-type behavioural events are the earlier shape and remain accepted indefinitely.
    </ParamField>
