...
Beyond the subscription gate, a few endpoints require a specific **plan feature** and return `403 FEATURE_NOT_AVAILABLE` when the plan doesn't include it:

| Endpoint | Feature | Plans |
|---|---|---|
| [Export verified bots](/endpoints/verified-bots-export) | `verified-bots-export` | Business, Owner-lifetime |
...
Upgrade the plan to unlock the feature, or check `GET /v1/account` for the caller's context.
